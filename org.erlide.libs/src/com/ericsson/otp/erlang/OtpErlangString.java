...
//    	System.out.println("OtpErlangString: " + str);
////    	CharacterEncodeConverter convert = new CharacterEncodeConverter();
////        byte[] fullByte = convert.gbk2utf8("����");
//        String fullStr = new String(str, "UTF-8");
...
//    	return str;
    	String tempStr = str;
//		try {
//			tempStr = new String(str.getBytes("ISO8859-1"),"UTF-8");
//			System.out.println("OtpErlangStringGBK: " + tempStr);
//			tempStr = new String(str.getBytes("UTF-8"), "GBK");
//			System.out.println("OtpErlangStringUTF-8: " + tempStr);
//			tempStr = new String(str.getBytes("ISO8859-1"), "UTF-8");
//			System.out.println("OtpErlangStringISO8859: " + tempStr);
